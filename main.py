...
class Application():
    def __init__(self,master,*args,**kwargs):
        ...
        self.left=Frame(master,width=700,height=768,bg='beige')
        ...
        #components
        self.heading=Label(self.left,text="Street Foods ",font=('arial 20 bold'),fg='white',bg='black')
        ...
        #enter stuff
        self.enterid=Label(self.left,text="ORDER ID",font=('arial 18 bold'),fg='white',bg='black')
        ...
        self.productname=Label(self.left,text="",font=('arial 12 bold'),bg='white',fg='steelblue')
        self.productname.place(x=0,y=250)

        self.pprice = Label(self.left, text="", font=('arial 12 bold'), bg='white', fg='steelblue')
        self.pprice.place(x=0, y=290)

        self.pStock = Label(self.left, text="", font=('arial 12 bold'), bg='white', fg='steelblue')
        self.pStock.place(x=0, y=330)
    ...
    def ajax(self,*args,**kwargs):
        ...
        if self.pc:
          ...
          self.productname.configure(text="Order's Name: " +str(self.get_name),fg='white',bg='black')
          self.pprice.configure(text="Price:. "+str(self.get_price),fg='white',bg='black')
          self.pStock.configure(text="Stock:. "+str(self.get_stock),fg='white',bg='black')
    ...
    def add_to_cart(self,*args,**kwargs):
        ...
        if  self .quantity_value >int(self.get_stock):
            ...
            for self.p in products_list:
                self.tempname=Label(self.right,text=str(products_list[self.counter]),font=('arial 18 bold'),bg='black',fg='white')
                self.tempname.place(x=0,y=self.y_index)
                self.tempqt = Label(self.right, text=str(product_quantity[self.counter]), font=('arial 18 bold'), bg='black', fg='white')
                self.tempqt.place(x=300, y=self.y_index)
                self.tempprice = Label(self.right, text=str(product_price[self.counter]), font=('arial 18 bold'), bg='black', fg='white')
                ...
                #total confugure
                self.total_l.configure(text="Total : . "+str(sum(product_price)),bg='black',fg='white')
                #delete
    ...
    def change_func(self,*args,**kwargs):
        ...
        #label change
        self.c_amount=Label(self.left,text="Change: . "+str(self.to_give),font=('arial 18 bold'),fg='red',bg='black')
...
root.title("Robert's Street Foods")
root.mainloop()